...
//
//    User user = User.builder().id("igor").nickname("igor").email("igor").password("igor").build();
//
//    @Test
...
//            headers = new HttpHeaders();
//            headers.setContentType(MediaType.APPLICATION_JSON);
//            SignupRequest signupRequest = SignupRequest.builder().username(user.getNickname()).email(user.getEmail())
//                    .password(user.getPassword()).build();
//            HttpEntity<String> request = new HttpEntity<>(objectMapper.writeValueAsString(signupRequest), headers);
...
//        headers = new HttpHeaders();
//        headers.setContentType(MediaType.APPLICATION_JSON);
//        LoginRequest loginRequest = LoginRequest.builder().username(user.getNickname()).password(user.getPassword()).build();
//        HttpEntity<String> request = new HttpEntity<>(objectMapper.writeValueAsString(loginRequest), headers);
//        JwtResponse retJwt = restTemplate.postForObject(signInUrl, request, JwtResponse.class);
//        assertNotNull(retJwt);
//        assertNotNull(retJwt.getJwt());
//        jwt = retJwt.getJwt();
//    }
//
//
